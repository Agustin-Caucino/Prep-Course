...
function colors(color) {
  ...
  var rta = "";
  switch (color){
    case 'blue':rta = 'This is blue';
    break;
    case 'red':rta = 'This is red';
    break;
    case 'green':rta = 'This is green';
    break;
    case 'orange': rta = 'This is orange';
    break;
    default: rta = "Color not found";
  }
  return rta;
}
...
function esEntero(numero) {
  ...
  // Tu código:
  if (parseInt(numero) === numero) return true;
  else return false;
  // con Math.floor se podria hacer de igual manera
}
...
function esPrimo(numero) {
  ...
  if(numero ===1 || numero === 0)return false;
    ...
    for (var i=1; i<numero; i++){
      if (((i != 1) && (i != numero)) && numero % i === 0) return false;
    }
    return true;
  }
}
